...
const Footer = () => {
  return (
    ...
    <div className="relative bg-gradient-to-b from-[#3a5f91] via-[#0a1d3a] to-[#000000] text-white py-12 px-4 overflow-hidden
                    md:py-16 md:px-8 lg:px-16">

      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 gap-y-10
        ...
        <div className="flex flex-col items-center text-center
          ...
          <Link to={"/homepage"}>
            <button className="font-Orbitron text-3xl lg:text-4xl font-extrabold text-white mb-3 tracking-wider
                               hover:text-blue-400 transition-colors duration-300 transform hover:scale-105">
              SpaceX.
            </button>
          </Link>
          <p className="text-sm leading-relaxed text-gray-300 w-full px-6
                        md:max-w-none md:px-0 md:mx-0">
            Exploring the frontiers of technology and innovation. Dedicated to
            delivering cutting-edge solutions and a seamless experience for a brighter future.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center text-center
                        md:items-start md:text-left">
          <h4 className="text-lg font-bold font-Orbitron mb-4 text-blue-300
                         md:text-xl md:mb-6">Quick Links</h4>
          <nav className="flex flex-col gap-3">
            <Link to={"/homepage"} className="text-gray-300 hover:text-white  duration-200 transition-all hover:scale-105  transform origin-center md:origin-left">Home</Link>
            <Link to={"/ai"} className="text-gray-300 hover:text-white transition-all duration-200 hover:scale-105 transform origin-center md:origin-left">AI Service</Link>
            <Link to={"/aboutuspage"} className="text-gray-300 hover:text-white transition-all duration-200 hover:scale-105 transform origin-center md:origin-left">About Us</Link>
            <Link to={"/contactuspage"} className="text-gray-300 hover:text-white transition-all duration-200 hover:scale-105 transform origin-center md:origin-left">Contact Us</Link>
          </nav>
        </div>
        ...
        <div className="flex flex-col items-center text-center
                        md:items-start md:text-left">
          <h4 className="text-lg font-bold font-Orbitron mb-4 text-blue-300
                         md:text-xl md:mb-6">Connect With Us</h4>
          ...
          <div className="flex justify-center gap-4 mb-6 md:gap-6 md:mb-8">
            ...
            {['facebook', 'instagram', 'linkedin', 'x-twitter'].map((platform) => (
              <a
                ...
                aria-label={platform === 'x-twitter' ? 'X (formerly Twitter)' : platform.charAt(0).toUpperCase() + platform.slice(1)}
              >
                <FontAwesomeIcon
                  icon={
                    platform === 'facebook'
          ...
          <div className="flex flex-col gap-2 text-sm text-gray-400 w-full px-6 mt-auto
                          md:px-0">
