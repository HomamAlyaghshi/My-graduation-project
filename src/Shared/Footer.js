...
const Footer = () => {
  return (
    <div className="bg-spaceDark h-[665px] md:h-full sm:h-[360px] py-[32px] md:px-[16px] sm:px-[160px] grid gap-[18px]">
      <div className="flex flex-col items-center sm:flex-row sm:justify-between">
        ...
        <div className="flex flex-col sm:flex-row text-white w-full sm:w-[392px] justify-between mt-10  sm:mt-0 font-inter text-[14px] font-[400] leading-[22px] text-center sm:text-left  sm:gap-0 ">
          <Link to={"/homepage"}>
