...
const BannerGrid = () => {
  return (
    <div className="w-full h-auto md:h-[700px] flex flex-col md:flex-row gap-[32px] md:gap-[64px] px-4 py-8  text-white">
      {/* العمود الأيسر */}
      <div className="relative flex-1 min-h-[300px] md:h-full">
        ...
        <div className="absolute top-[48px] left-[16px] sm:left-[48px] w-[90%] sm:w-[360px] flex flex-col items-start gap-[12px]">
          <p
            className="font-poppins text-[28px] sm:text-[34px] font-medium leading-[38px] tracking-[-0.6px]
  bg-space-text bg-clip-text text-transparent"
            style={{
              textShadow:
                "0 0 5px rgba(255, 185, 36, 0.9), 0 0 10px rgba(255, 185, 36, 0.8), 0 0 15px rgba(255, 185, 36, 0.7)",
            }}
          >
            Planets
          </p>
